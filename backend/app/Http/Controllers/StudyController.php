 ...
 * StudyController
 *
 * Consolidates the /api/dates, /api/forecast, and /api/simulate
 * endpoints that routes/api.php references.
 *
 * The actual logic lives in StudyCalculator — this controller
 * just validates input, delegates, and returns JSON.
 */
